...
byte ColorSensor::getResult(unsigned long red, unsigned long green, unsigned long blue)
{
	//Chapuz masivo //Tal
	if (red > 100 && green > 100 && blue > 100 &&
		red < 1500 && green < 1200 && blue < 1000) {
		return WHITE;
  	}
	else if (red > 100 && red < 1700) {
		return RED;
	}
...
byte ColorSensor::debGetColor()
{
	...
	return getResult(red, green, blue);;
}
